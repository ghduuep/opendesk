...
ActiveRecord::Schema[8.1].define(version: 2026_09_22_192936) do
  ...
  create_table "knowledge_base_categories", force: :cascade do |t|
    ...
    t.string "slug", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "slug"], name: "index_knowledge_base_categories_on_account_id_and_slug", unique: true
    t.index ["account_id"], name: "index_knowledge_base_categories_on_account_id"
  end
  ...
  add_foreign_key "knowledge_base_categories", "accounts"
